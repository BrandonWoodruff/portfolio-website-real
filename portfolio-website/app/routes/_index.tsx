   ...
   <div className="relative z-10 text-white text-center">
     <header className="z-10 flex items-center justify-between">
      <nav>
        ...
        </a><a href="#" className="hover:text-gray-400 dark:hover:text-white dark:text-gray-400">
        ...
        </a><a href="/contactMe" className="text-white hover:text-gray-400">Contact Me <ExternalLinkIcon className="w-4 h-4 inline"/></a>
        </div>
      </nav>
    </header>
     <br/><br/>
